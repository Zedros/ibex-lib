...
#ifndef __TEST_OPTIMIZERMOP_H__
#define __TEST_OPTIMIZERMOP_H__
...
class TestOptimizerMOP : public CppUnit::TestFixture {

public:

	CPPUNIT_TEST_SUITE(TestOptimizerMOP);
...
CPPUNIT_TEST_SUITE_REGISTRATION(TestOptimizerMOP);

} // namespace ibex

#endif // __TEST_OPTIMIZERMOP_H__
